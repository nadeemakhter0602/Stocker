...
class UpdateService {
  ...
  static Future<void> downloadAndInstall(
    ...
    showDialog(
      ...
      builder: (ctx) {
        ...
        return ValueListenableBuilder<double>(
          ...
          builder: (_, progress, _) => AlertDialog(
    ...
    try {
      ...
      final file = File('${tmpDir.path}/stocker-v$version.apk');
      ...
      const channel = MethodChannel('stocker/install');
